...
// Simple file upload hook implementation
function useFileUpload(options: { accept?: string }) {
...
export default function AvatarUploaderWithCropper() {
  const [
    { files, isDragging },
    {
      handleDragEnter,
    ...
    <div className="flex flex-col items-center gap-3">
      <div className="relative inline-flex">
        ...
        <button
          ...
          className="relative flex size-24 items-center justify-center overflow-hidden rounded-full border-2 border-dashed border-input bg-muted/30 outline-none transition-all hover:border-primary hover:bg-muted/50 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 data-[dragging=true]:border-primary data-[dragging=true]:bg-primary/10"
        ...
        {finalImageUrl && (
          <Button
            ...
            className="-top-1 -right-1 absolute size-7 rounded-full border-2 border-background bg-destructive text-destructive-foreground shadow-md hover:bg-destructive/90 focus-visible:border-background"
      ...
      <Dialog onOpenChange={setIsDialogOpen} open={isDialogOpen}>
        <DialogContent className="gap-0 p-0 sm:max-w-140 *:[button]:hidden">
          ...
          {previewUrl && (
            <Cropper.Root
              className="h-96 sm:h-120 relative flex cursor-move touch-none items-center justify-center overflow-hidden rounded-md border focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              image={previewUrl}
              aspectRatio={1}
            ...
            >
              <Cropper.Description className="sr-only">
                Crop your image by dragging the crop area
              </Cropper.Description>
